 ...
 */
FZN_BLACKBOX_EXPORT void FZN_BLACKBOX_CALL fzn_blackbox(
    void *instance, const int64_t *int_in, size_t int_in_size, const double *float_in,
    size_t float_in_size, int64_t *int_out, size_t int_out_size, double *float_out,
