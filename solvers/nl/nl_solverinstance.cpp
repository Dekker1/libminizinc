...
namespace MiniZinc {
  ...
  SolverInstanceBase* NL_SolverFactory::doCreateSI(std::ostream& log, SolverInstanceBase::Options* opt) {
    return new NLSolverInstance(log, opt);
  }
  ...
  NLSolverInstance::NLSolverInstance(std::ostream& log, SolverInstanceBase::Options* options)
