...
namespace MiniZinc {
  ...
  public:
    ...
    public:
      ...
      virtual void subscribe(Interpreter& i, Definition* d) const = 0;
      virtual void unsubscribe(Interpreter& i, Definition* d) const = 0;
      virtual void propagate(Interpreter& i, Definition* d) const = 0;
    };
  protected:
  ...
  namespace BytecodePrimitives {
    ...
    public:
      ...
      virtual void subscribe(Interpreter& i, Definition* d) const {}
      virtual void unsubscribe(Interpreter& i, Definition* d) const {}
      virtual void propagate(Interpreter& i, Definition* d) const { assert(false); }
    };
    ...
    public:
      ...
      virtual void propagate(Interpreter& i, Definition* d) const {}
    };
    ...
    //{BOOLNOT,1}, {CLAUSE,2}, {FORALL,1}, {EXISTS,1}, {INT_SUM,1}, {INT_TIMES,2}, {LINEXP,3}
