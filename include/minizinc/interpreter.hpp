...
namespace MiniZinc {
  inline
  std::pair<Val, bool> Interpreter::cse_find(int proc, const CSEKey& key, BytecodeProc::Mode& mode) {
  ...
  inline
  void Interpreter::cse_insert(int proc, CSEKey& key, BytecodeProc::Mode& mode, Val& val) {
